...
/**
 * Renders a single form input for an inspectorNativeSharedUtils field model, picking the right
 * base Lightning input component for the field's data type and emitting normalized change events.
 * @alias InspectorNativeFormField
 * @extends LightningElement
 * @hideconstructor
 */
export default class InspectorNativeFormField extends LightningElement {
  /**
   * Field model built by inspectorNativeSharedUtils.buildFieldModels: { apiName, label, type,
