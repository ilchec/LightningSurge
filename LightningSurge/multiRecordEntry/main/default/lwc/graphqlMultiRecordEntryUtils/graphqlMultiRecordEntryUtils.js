import { buildFieldModelFromFieldInfo, buildFieldModels, serializeGqlValue } from 'c/graphqlMultiRecordEntrySharedUtils';
...
/**
 * Builds a GraphQL query for every active Record Type on the given object, so
 * graphqlMultiRecordEntry can decide whether a layout picker is needed (more than one) and, if a
